...
$"""
            ...
            if os.path.exists("summary.txt"):
                ...
                TestMain.correct_output += 2

                os.remove("summary.txt")
        finally:
            sys.stdout = saved_stdout

    def test_school_report_bcit_output_valid(self):
        """ main.py school BCIT """
        saved_stdout = sys.stdout
        try:
            out = io.StringIO()
...
$"""
    ...
    def test_school_report_uvic_output_valid(self):
        """ main.py school UVIC """
        saved_stdout = sys.stdout
        try:
            out = io.StringIO()
...
School:          UVIC
Number Courses:  2
Courses:         COMP1001,STAT1000
Number Students: 40
Average Grade:   77.0
Median Grade:    82.1%
Top Student:     V0001007
Top Grade:       95.5%
Bottom Student:  V0001217
Bottom Grade:    22.3%\s*
$"""
